...
/**
 * Servlet implementation class News_insert_servlet
 */
public class News_insert_servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public News_insert_servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//System.out.print(title+time+location+company+field+from+urll);
