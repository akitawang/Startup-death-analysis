        ...
        <div id="wrapper">
            ...
            <!-- Left Sidebar End -->
					...
					<div class="form-group col-md-12">
                        	 <h4 class="header-title">子领域操作</h4>
                         </div>
     ...
     <script>
  		 ...
  		 $(document).ready(function() {
			 $("#rec").click(function(){
   		          ...
   		          //设置linkToCart的href的值
   		          $.ajax({
	                url:"/FinalProject/Company_field_rec_servlet?id="+id+"&number="+number,
	                type:"post",
	                success:function(data){
	                	if(data > 0){
	                		alert("操作成功");
	                		 window.location.href='/FinalProject/Company_field_list_servlet';
	                	}
	                	else{
	                		alert("操作失败");
	                	}
    		 ...
    		 $(document).ready(function() {
    			 $("#del").click(function(){
   		          ...
   		          //设置linkToCart的href的值
   		          $.ajax({
	                url:"/FinalProject/Company_field_del_servlet?id="+idd,
	                type:"post",
	                success:function(data){
	                	if(data > 0){
	                		alert("操作成功");
