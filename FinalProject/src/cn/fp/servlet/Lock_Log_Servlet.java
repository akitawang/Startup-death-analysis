...
/**
 * Servlet implementation class Lock_Log_Servlet
 */
public class Lock_Log_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Lock_Log_Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(ub!=null&&ub.getUserpass().equals(password)) {
			...
			String url = request.getContextPath()+"/logout.jsp?name="+username;
