                        ...
                        <div class="card-box">
                           ...
                           <table  class="table table-hover mb-0">
                            ...
                            <div style="margin:0 auto;text-align:center;">
								<c:if test="${pageNos>0 }">
								<a href="index?pageNos=1" class="btn btn-light">首页</a>
								<a href="index?pageNos=${pageNos-1 }" class="btn btn-light">上一页</a>
								</c:if>
								<c:if test="${pageNos <recordCount }">
								<a href="index?pageNos=${pageNos+1 }" class="btn btn-light">下一页</a>
								<a href="index?pageNos=${recordCount }" class="btn btn-light">末页</a>
								</c:if>
							</div>
							<div style="margin:0 auto;text-align:center;">
								<form action="index">
