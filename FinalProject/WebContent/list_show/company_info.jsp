            ...
            <!-- Left Sidebar End -->
					...
					<div class="row">
						 ...
						 <div class="form-group col-md-2">
                          ...
                          <div class="form-group col-md-1">
                                 <a class="btn btn-primary" href="/FinalProject/list_show/company_insert.jsp">添加</a>
                          </div>
                      </div>
                   </form>      
                        ...
                        <div class="card-box">
                           ...
                           <table  class="table table-hover mb-0">
                            ...
                            <div style="margin:0 auto;text-align:center;">
								<c:if test="${pageNos>0 }">
								<a href="List_company_servlet?pageNos=1" class="btn btn-light">首页</a>
								<a href="List_company_servlet?pageNos=${pageNos-1 }" class="btn btn-light">上一页</a>
								</c:if>
								<c:if test="${pageNos <recordCount }">
								<a href="List_company_servlet?pageNos=${pageNos+1 }" class="btn btn-light">下一页</a>
								<a href="List_company_servlet?pageNos=${recordCount }" class="btn btn-light">末页</a>
								</c:if>
							</div>
							<div style="margin:0 auto;text-align:center;">
								<form action="List_company_servlet">
								<a  >共${recordCount}页 </a> 
								<a>       转到第</a>
