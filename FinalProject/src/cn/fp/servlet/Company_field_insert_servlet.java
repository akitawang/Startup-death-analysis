...
/**
 * Servlet implementation class Company_field_insert_servlet
 */
public class Company_field_insert_servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Company_field_insert_servlet() {
        super();
