   ...
   <body>
          ...
          <div class="category_section">
            <div class="card bg-white m-b-30">
					...
					<div class="form-group col-md-12">
                        	 <h1 class="header-title">${U.com_name} 生平介绍</h1>
                     </div>
					...
					<div class="row">                                  
	                      <div class="form-group col-md-3">
	                          ...
	                          <input  class="form-control" id="number" readonly="readonly" name="number" value="${U.number} ">
	                      </div>
	                      <div class="form-group col-md-3">
	                          <label for="exampleInputEmail1">序号</label>
	                          <input  class="form-control" id="id" readonly="readonly" name="id" value="${U.id} ">
	                      </div>
	                      <div class="form-group col-md-3">
	                          <label for="exampleInputEmail1">公司名称</label>
	                          <input  class="form-control" id="com_name" name="com_name" readonly="readonly" value="${U.com_name} ">
	                      </div>
	                      <div class="form-group col-md-3">
                            <label for="exampleInputEmail1">所在区域</label>    
                            <input  class="form-control" readonly="readonly"id="com_addr" name="com_addr" value="${U.com_addr}">  
					...
					<div class="row">
						 <div class="form-group col-md-3">
	                          ...
	                          <input  class="form-control" readonly="readonly"id="cat" name="cat" value="${U.cat}">
	                      </div>
	                      <div class="form-group col-md-3">
	                          <label for="exampleInputEmail1">所属子领域</label>
	                          <input  class="form-control" readonly="readonly"id="se_cat" name="se_cat" value="${U.se_cat}">
	                      </div>
	                      <div class="form-group col-md-6">
	                          <label for="exampleInputEmail1">公司描述</label>
	                          <textarea  class="form-control" readonly="readonly" id="com_des"  name="com_des"   rows="3">${U.com_des}</textarea>
	                      </div>
	                 </div> 
                      <div class="row">                                  
	                      <div class="form-group col-md-3">
	                          <label for="exampleInputEmail1">成立日期</label>
	                          <input  class="form-control" readonly="readonly"id="born_data" name="born_data" value="${U.born_data}">
	                      </div>
	                      <div class="form-group col-md-3">
	                          <label for="exampleInputEmail1">倒闭日期</label>
	                          <input  class="form-control" readonly="readonly" id="death_data"  name="death_data" value="${U.death_data}">
	                      </div>
	                      <div class="form-group col-md-3">
	                          <label for="exampleInputEmail1">存活时间</label>
	                          <input  class="form-control" readonly="readonly" id="live_days"  name="live_days" value="${U.live_days}">
	                      </div>
	                       <div class="form-group col-md-3">
	                          <label for="exampleInputEmail1">投资公司</label>
	                          <input  class="form-control" readonly="readonly" id="invest_name" name="invest_name" value="${U.invest_name}">
	                      </div>
                      </div>
                      <div class="row">     
                       		<div class="form-group col-md-3">
                            <label for="exampleInputEmail1">融资情况</label>      
                            <input  class="form-control" readonly="readonly" id="financing"  name="financing" value="${U.financing}">
                           
                          </div>      
	                      <div class="form-group col-md-3">
	                          <label for="exampleInputEmail1">融资总额(元)</label>
	                          <input  class="form-control" readonly="readonly" id="total_money"  name="total_money" value="${U.total_money}0,000">
	                      </div>
	                      <div class="form-group col-md-6">
	                          <label for="exampleInputEmail1">死亡原因</label>
	                          <input  class="form-control" readonly="readonly" id="death_reason" name="death_reason" value="${U.death_reason} ">
	                      </div>
                      ...
                      <div class="row">                                  
	                      ...
	                      <div class="form-group col-md-3">
	                          ...
	                          <input  class="form-control" readonly="readonly" id="ceo_name"  name="ceo_name" value="${U.ceo_name}">
	                      </div>
	                      <div class="form-group col-md-3">
	                          <label for="exampleInputEmail1">法人职位</label>
	                          <input  class="form-control" readonly="readonly" id="ceo_des" name="ceo_des" value="${U.ceo_des}">
	                      </div>
	                      <div class="form-group col-md-6">
	                          <label for="exampleInputEmail1">CEO简介</label>
	                          <textarea  class="form-control" readonly="readonly" id="ceo_per_des"  name="ceo_per_des"   rows="3">${U.ceo_per_des}</textarea>
      ...
      <script type="text/javascript">
      	 ...
      	 $('#sa-image').click(function () {
      		 var vname =  $("#com_name").val();
             swal({
                 title: '操作成功',
                 text: '您已成功为公司：'+vname+'  上香',
                 imageUrl: ' ',
                 imageHeight: 50,
                 animation: false,
