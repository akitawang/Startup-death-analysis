        ...
        <div id="wrapper">
            ...
            <!-- Left Sidebar End -->
					...
					<div class="form-group col-md-12">
                        	 <h4 class="header-title">插入新的投资公司</h4>
                         </div>
					<div class="general-label">
					<form method = "get" id="pass" action="/FinalProject/Invest_company_insert_servlet">
					<div class="row">
	                      <div class="form-group col-md-6">
	                          <label for="exampleInputEmail1">投资公司名称</label>
	                          <input type="text" class="form-control" id="name" name="name" placeholder="投资公司名称">
	                      </div>
                      ...
                      <a href="/FinalProject/Invest_company_list_servlet" class="btn btn-primary">刷新</a>  
                      </div>
                   </form>      
                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                        <div class="form-group col-md-12">
                        	 <h4 class="header-title">投资公司信息展示</h4>
                         </div>
                      </div>
                           ...
                           <table id="datatable-buttons" class="table table-hover mb-0">
                                ...
                                <tr>
                                    ...
                                    <td>${U.number}</td>
                                    <td>
                                    	<a href="/FinalProject/rectify_info/invest_company_do.jsp?id=${U.rank}&name=${U.name}&number=${U.number}">
    	        ...
    	        $("#pass").submit(function(e){
    	        	...
    	        	$.ajax({
    	                ...
    	                success:function(data){
    	                	if(data > 0){
    	                		alert("操作成功");
    	                		window.location.href='/FinalProject/Invest_company_list_servlet';
    	                	}
    	                	else{
    	                		alert("操作失败");
    	                	}
